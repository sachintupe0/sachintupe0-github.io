...
arrayOfPuzzl = "";
var indexOfQuery = "";
const totalAmount = 100; // Total amount to distribute
...
function openPopup() {
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy:33 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy:44 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy:55 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy:66 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy: 77 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy: 88 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy:99 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy:10 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
    ...
    <h2>Puzzle</h2>
    <div id="puzzleQuestions">
        <button onclick="selectPuzzle('easy')">Easy:1111 What is 12 + 2?</button><br>
        <button onclick="selectPuzzle('medium')">Medium: What is the capital of India?</button><br>
        <button onclick="selectPuzzle('hard')">Hard: How many continents 7 are there?</button>
     </div>
    <input type="text" id="answerInput" class="puzzle-input" style="display: none;">
